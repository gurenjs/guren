...
This edition is verified against `create-guren-app` 1.17 and Guren 2.27. If your scaffold prints a newer version, the chapters most likely still hold; if a step disagrees with what you see, the [CLI reference](../guides/cli.md) has the current command surface.
