...
export type { ApplicationOptions, AuthPluginOptions, ConfiguredDefinition, I18nPluginOptions, InertiaApplicationOptions } from './http/Application'
...
export type { ConfigDefinition, ConfigDefinitions, HttpConfig, OAuthConfig } from './config/define'
