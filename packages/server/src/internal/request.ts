 ...
 * repeated form field collapses, what an unreadable body falls back to, and
 * how repeated query parameters flatten for a validation schema.
 *
 ...
 */
export { parseRequestBody, asRecord, flattenRequestQueries } from '../http/request'
export type { RequestBodyContext, RequestQueryContext } from '../http/request'
