...
const [SCAFFOLD, , , HTTP] = planStepIds(derivePlanTasks(PLAN)) as [string, string, string, string]
...
async function createApp(name: string, state?: Partial<PlanState>, plan: unknown = loadCommentsPlan()): Promise<string> {
