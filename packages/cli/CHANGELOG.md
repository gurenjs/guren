...
- f1fa11f: `guren plan:render` writes a page that speaks `en` and `ja`. Both dictionaries are
...
- 46c8dea: `guren plan:render` now runs the RFC 0030 §2 checks it renders. The command reads
...
- fbcd04f: Add `guren plan:render <plan.json> [-o <file>]` (RFC 0030 §3): an implementation
...
- 07b623c: `guren add ai` installs `ai@^7.0.106`, the first release with `experimental_evaluate`, which `@guren/plugin-ai`'s evaluation models need.
...
- Updated dependencies [ef9398d]
- Updated dependencies [2ef86a8]
- Updated dependencies [382a6a7]
- Updated dependencies [6a5d490]
- Updated dependencies [8555cc4]
- Updated dependencies [d8e24e8]
  - @guren/server@2.26.0
  - @guren/orm@2.12.0
