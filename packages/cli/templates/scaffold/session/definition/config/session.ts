...
// request that needs one, but this object is resolved when the app boots, so
...
// with REDIS_URL declared in config/env.ts — imported only when used, since that
// module pulls in ioredis.
