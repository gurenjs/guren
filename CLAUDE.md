...
bunx guren check --docs         # Doc-link checks only: OKF frontmatter (type/entities/related) + body markdown links + @docs tags + `(AC-…)` citations against test titles (warns; exits non-zero on failures)
