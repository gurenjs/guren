...
bunx guren add ai --provider anthropic      # In-process AI agents (RFC 0029): config/ai.ts, the provider key in config/env.ts, aiPlugin(), bun add of the packages (--no-install prints it)
