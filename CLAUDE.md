...
bunx guren plan "comments on posts" --print-prompt  # The prompt and draft JSON Schema an in-session agent writes a plan from (RFC 0030 §8); calls no model (--json). Without --print-prompt, and with --revise, it exits 1
