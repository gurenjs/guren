 ...
 *
 * Deliberately ports only the props content pages use today; `alternates`,
 * `markdownPath`, and `jsonLd` stay with the React component until a
 * content page needs them (JSON-LD additionally needs
...
export const Seo: FC<SeoProps> = ({ title, description, path, locale = 'en', ogType = 'website' }) => {
